...
//        invalidate();
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        DrawUtils.drawSupLine(canvas, mTextPaint, getWidth(), getHeight(), mLastShowText);
        canvas.drawText(mLastShowText, 100, 100, m_bitmapPaint);
    ...
    public void setLastShowText(String lastShowText) {
        clear();
        this.mLastShowText = lastShowText;
        invalidate();
    }
    ...
    protected void initialize() {
        ...
        m_bitmapPaint.setTextSize(sp2px(30));
        m_bitmapPaint.setStrokeWidth(1);
        m_bitmapPaint.setTypeface(MyApp.getInstance().getDefaultTypeface());
        setStrokeType(PenType.Pen);
        HALF_STROKE_WIDTH = m_penSize / 2;
        mPhotoSize.setX(640);
        mPhotoSize.setY(480);
        mTextPaint.setTextSize(DrawUtils.sp2px(getContext(), 200));
        mTextPaint.setTypeface(MyApp.getInstance().getDefaultTypeface());
    }
